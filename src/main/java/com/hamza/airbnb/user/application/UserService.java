...
import com.hamza.airbnb.user.mapper.UserMapper;
import com.hamza.airbnb.user.repository.UserRepository;
...
public class UserService {
    ...
    public Optional<ReadUserDTO> getByEmail(String email) {
        ...
        return oneByEmail.map(userMapper::readUserToReadUserDTO);
    }
    ...
    public Optional<ReadUserDTO> getByPublicId(UUID publicId) {
        ...
        return oneByPublicId.map(userMapper::readUserToReadUserDTO);
    }
